...
<main class="wrap">
    ...
    <!-- Ajout du background personnalisé avec les photos du site -->
    <?php 
    ...
    <!-- Ajout de la nonce: sécurité avec l'API-->
    <script>
        var ajaxurl = '<?php echo esc_url(admin_url('admin-ajax.php')); ?>';
        var nonce = '<?php echo wp_create_nonce('custom_filter_nonce'); ?>';
    </script>

    <!-- Ajout des Filtres catégories/formats/trier part -->
    ...
    <!-- Ajout des photos sur la page d'acceuil -->
